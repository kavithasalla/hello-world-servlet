...
// for display purposes
      ...
      git 'https://github.com/kavithasalla/hello-world-servlet.git'
...
post {
        success {
            mail to:"kavitharcshekar@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"kavitharcshekar@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
